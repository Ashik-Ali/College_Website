<?php 
    ...
    try{
            ...
            if(empty($status)){
                 throw new Exception ("Please Update Status Box.");
            }
            ...
            if(!empty($file_name)){
                ...
                if(in_array($file_ext, $allow)){
                 ...
                 if(move_uploaded_file($tmp_name, $target)){
                     ...
                     $update = "UPDATE teachers SET thr_name='$name', department='$department', designation='$designation', home_district='$home_district', photo='$unique_name', join_year='$join_year', status='$status' WHERE id='$id'";
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
           <?php  
               ...
               $single = "SELECT * FROM teachers WHERE id='$id'";
  ...
  <strong>Done.</strong>  '.$scs_msg.'</div>';}
                ...
                <h2>Status:  <input type="text" value="<?php echo $row['status']; ?>" name="status"></h2>
