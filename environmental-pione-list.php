            ...
            <div class="row"><br>
                <div class="col-md-8 col-md-offset-2" style="background: #ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='5' && department='environmental'";
                        ...
                        if($run->num_rows > 0){
                            while($row = $run->fetch_assoc()){
                                ?>
                                    ...
                                    <h1 style="background: #585454;padding: 15px;font-size: 50px;color: cyan;width: 515px;border-radius: 20px;text-align: center;font-weight: bold;margin: 30px 110px;"><?php echo $row["designation"] ?></h1>
                                    <h1 style="font-weight: bold;background: #237122;width: 515px;padding: 15px;text-align: center;color: white;border-radius: 20px;margin: 50px 110px;">Department: <?php echo $row["department"] ?></h1>
