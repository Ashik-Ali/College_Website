            ...
            <div class="row"><br>
                <div class="col-md-8 col-md-offset-2" style="background:#ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='3' && department='civil'";
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="background:#ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='3' && department='electrical'";
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="background:#ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='3' && department='computer'";
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="background:#ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='3' && department='electronics'";
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="background:#ffffff;border-radius:25px;">
                    <?php
                        ...
                        $select = "SELECT * FROM teachers WHERE status='3' && department='Non-tech'";
