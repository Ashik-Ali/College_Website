                    ...
                    <?php
                        ...
                        if($run->num_rows > 0){
                            ...
                            ?>
                                ...
                                <h2 style="background: #757474;color: #00f3ff;font-weight: bold;padding: 20px;width: 700px;text-align: center;font-size: 39px;border-radius: 20px;margin: 35px 25px;"><?php echo $row["designation"]; ?></h2>
