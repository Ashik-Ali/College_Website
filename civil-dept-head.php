                    ...
                    <?php
                        ...
                        if($run->num_rows > 0){
                            ...
                            ?>
                                ...
                                <h2 style="text-align: center;font-size: 60px;color: #0a082f;font-weight: bold;border-bottom: 10px dotted #050831;margin: 20px 100px;"><?php echo $row["thr_name"]; ?></h2>
                                ...
                                <h2 style="background: #757474;color: #00f3ff;font-weight: bold;padding: 20px;width: 650px;text-align: center;font-size: 43px;border-radius: 20px;margin: 35px 50px;"><?php echo $row["designation"]; ?></h2>
